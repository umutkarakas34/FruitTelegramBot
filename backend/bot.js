...
bot.start(async (ctx) => {
    ...
    const url1 = `https://614c-188-132-191-150.ngrok-free.app/?telegram_id=${telegramId}&username=${username}&firstname=${firstname}&lastname=${lastname}&referralCode=${referralCode}`;
