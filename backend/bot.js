...
bot.start(async (ctx) => {
    ...
    const url1 = `https://c17f-176-89-31-90.ngrok-free.app/?telegram_id=${telegramId}&username=${username}&firstname=${firstname}&lastname=${lastname}&referralCode=${referralCode}`;
